        ...
        <div className='mt-[64px] bg-[#3f3f3f] lg:p-[32px] mobile:px-[16px] mobile:py-[48px]'>
            <div className='flex gap-[32px] lg:flex-row mobile:flex-col'>
                ...
                <div className='lg:w-[50%] mobile:w-full text-[#fff]'>
                    <h4 className='text-2xl font-[600] mb-[24px]'>
                        Nguồn truyện tranh
                        <a className='text-[#10b981] font-[600] ml-[8px] hover:underline' target="_blank" rel="noreferrer" href='https://www.facebook.com/thanh.at.297093'>ClowTruyen</a>
                    </h4>
                ...
                <div className='lg:w-[25%] mobile:w-full text-[#fff]'>
                    ...
                    <div className='flex flex-col gap-[12px]'>
                        <a href='https://www.facebook.com/thanh.at.297093' target="_blank" rel="noopener" className='text-xl hover:text-[#10b981] duration-300'>
